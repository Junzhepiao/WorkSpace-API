  ...
  return knex('users').del()
    .then(function () {
      ...
      return knex('users').insert([
        ...
        {first_name: "Troy", last_name: 'Amelotte', email:"admin1@gmail.com", password:"admin", role:"Senior Software Engineer", img_url:"https://avatars3.githubusercontent.com/u/20520404?s=460&v=4", phone:9876543210, sick_hours:40, vacation_hours:80, active: false},
